  ...
  """
    ...
    def __init__(
        ...
        **kwargs):
        ...
        sequence_output = tf.keras.layers.Input(shape=(sequence_length,
                                                       hidden_size),
                                                dtype=tf.float32,
        ...
        # sequence_output, all_layer_output = network(network_inputs)
        ...
        super(BertPretrainer, self).__init__(inputs=inputs,
                                             outputs=[lm_outputs],
                                             **kwargs)
